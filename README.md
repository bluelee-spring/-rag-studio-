...
| 数据实验台 | RAG应用于数据预处理思路 | 批量分类结果 |
|:---:|:---:|:---:|
| ![数据实验台](./docs/屏幕截图%202026-08-03%20173430.png) | ![RAG应用于数据预处理思路](./docs/屏幕截图%202026-08-03%20211835.png) | ![批量分类](./docs/屏幕截图%202026-08-04%20161603.png) |
